const translations = {
  en: {
    ...
    about: "About Me",
    aboutText: "A back-end developer with 2 years of experience specializing in ERP system development. Proficient in Python, JavaScript, and HTML, with a strong understanding of server-side logic, database integration, and web application architecture. I also have experience in trainning AI models and developing web applications.",
    programSkills: "Program Skills",
    languages: "Languages",
    languagesName1: "English",
    languagesName2: "German",
    experience: "Experience",
    experienceText: "2 years of experience in ERP system development at Viidoo, a technology company in Haiphong, Vietnam. Proficient with Odoo framework and PostgreSQL database management. While working at Viidoo, I have successfully completed several projects, including the development of a warehouse management system and a customer relationship management system. I have also collaborated with the front-end team to integrate the back-end with the user interface, ensuring a seamless user experience.",
    education: "Education",
  ...
  de: {
    ...
    about: "Über mich",
    aboutText: "Back-End-Entwickler mit 2 Jahren Erfahrung in der Entwicklung von ERP-Systemen. Versiert in Python, JavaScript und HTML mit fundiertem Verständnis für serverseitige Logik, Datenbankintegration und Webanwendungsarchitektur. Ich habe auch Erfahrung in der Schulung von KI-Modellen und der Entwicklung von Webanwendungen.",
    programSkills: "Programmierkenntnisse",
    languages: "Sprachen",
    languagesName1: "Englisch",
    languagesName2: "Deutsch",
    experience: "Erfahrung",
    experienceText: "2 Jahre Erfahrung in der Entwicklung von ERP-Systemen bei Viidoo, einem Technologieunternehmen in Haiphong, Vietnam. Versiert im Odoo-Framework und in der Verwaltung von PostgreSQL-Datenbanken. Während meiner Tätigkeit bei Viidoo habe ich erfolgreich mehrere Projekte abgeschlossen, darunter die Entwicklung eines Lagerverwaltungssystems und eines Kundenbeziehungsmanagementsystems. Ich habe auch mit dem Front-End-Team zusammengearbeitet, um das Back-End mit der Benutzeroberfläche zu integrieren und so ein nahtloses Benutzererlebnis zu gewährleisten.",
    education: "Studium",
